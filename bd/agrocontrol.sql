...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 20-11-2023 a las 04:22:04
...
('b7clKzNLi7', '7777', 'Cristiano Ronaldo', 'Ronaldo Dos santos', '213243', 'Al nassr', 'OPERADOR MAQUINARIA', 'INACTIVO', 'elbicho@siuu.com', '89defae676abd3e3a42b41df17c40096'),
...
--
ALTER TABLE `horas_trabajadas`
  MODIFY `id_horas_trabajadas` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `horas_trabajadas`
  ADD CONSTRAINT `horas_trabajadas_ibfk_1` FOREIGN KEY (`id_asignacion`) REFERENCES `asignaciones` (`id_asignacion`);
